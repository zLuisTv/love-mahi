...
export default function MusicPage() {
    ...
    >([
        ...
        },
        {
            ...
            srcMusic: "/audio/Stephen Sanchez - Until I Found You.mp3",
            imgSrc: "/sunshine/img-2.jpg"
        },
        {
            title: "Love Story",
            srcMusic: "/audio/Indila - Love Story.mp3",
            imgSrc: "/sunshine/img-3.jpg"
        },
        {
            title: "Heather",
            srcMusic: "audio/Conan Gray - Heather.mp3",
            imgSrc: "/sunshine/img-4.jpeg"
        },
        {
            title: "Only",
            srcMusic: "audio/Lee Hi - ONLY.mp3",
            imgSrc: "/sunshine/img-12.jpg"
        },
    ]);
    ...
    return (
        <div className={`${dark && "dark"}`}>
            ...
            {open ? (
                <div className="fixed inset-x-0 bottom-0 flex flex-col items-center rounded-t-[50px] border-x border-t border-white bg-white bg-opacity-30 pb-5 backdrop-blur-sm dark:border-none dark:bg-black dark:bg-opacity-70">
                    ...
                    <div className="mt-4 mb-4 flex w-full items-center justify-between px-12 md:mt-2">
                        <div className="flex flex-col items-start dark:text-white">
                            ...
                            <span className="text-xl opacity-70">My Love Album</span>
                        </div>
                        <Image
                ...
                <div className="fixed inset-x-0 bottom-0 flex flex-col items-center rounded-t-[50px] border-x border-t border-white bg-white bg-opacity-30 pb-16 backdrop-blur-sm dark:border-none dark:bg-black dark:bg-opacity-70 md:pb-8">
                    <div className="mt-6 h-[5px] w-32 rounded-full bg-black bg-opacity-50 backdrop-blur-sm dark:bg-white dark:bg-opacity-70 md:mt-4" />
                    <span className="mt-6 text-center text-[28px] font-semibold dark:text-white md:mt-4">
                        {playingList[currentSong].title}
                    </span>
