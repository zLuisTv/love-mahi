    ...
    return (
        <div className='flex flex-col items-center'>
            {countdownFinished ? (
                ...
                <div className='flex'>
                    <p className='text-8xl font-extralight mobile-s:text-[58px]'>{formatValue(span_days)}:{formatValue(span_hours)}:{formatValue(span_minutes)}:{formatValue(span_seconds)}</p>
                </div>
            )}
        </div>
    )
